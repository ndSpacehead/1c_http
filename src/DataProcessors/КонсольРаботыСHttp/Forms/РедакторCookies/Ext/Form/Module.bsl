...
Процедура АтрибутыПеченькиПриИзменении(Элемент)
	ТекущиеДанные = Элемент.ТекущиеДанные;
	ТекущиеДанные.Активно = (ТекущиеДанные.Активно И (ЗначениеЗаполнено(ТекущиеДанные.Значение) ИЛИ ТекущиеДанные.Ключ = РаботаСHttpПовтИсп.СвойствоПеченькаЗащищенноеСоединение()));
