...
Процедура ВывестиТелоОтветаJSON(Знач Текст)
	...
	ЧастиТекста.Добавить(ТекстHTMLОтобраденияJSONНачало());
	ЧастиТекста.Добавить(Текст);
	ЧастиТекста.Добавить(ТекстHTMLОтобраденияJSONОкончание());
...
&НаКлиенте
Функция ТекстHTMLОтобраденияJSONНачало()
	Возврат
		"<!DOCTYPE html>
		|<html>
		|<head>
...
&НаКлиенте
Функция ТекстHTMLОтобраденияJSONОкончание()
	Возврат
		"');
