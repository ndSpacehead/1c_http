...
Процедура ВыполнитьЗапрос(Команда)
	...
	Ответ.УстановитьФорматированнуюСтроку(Новый ФорматированнаяСтрока(?(
	    ТелоОтветаВФайл,
		"файл",
		?(
...
Функция КодЗапросаКонсоли()
	...
	ИначеЕсли ТипАвторизации = ТипАвторизацииСписокВыбора[4].Значение Тогда // Bearer
		ЧастиКода.Добавить(СтрШаблон("	.УстановитьBearerАвторизацию(ДополнительныеПараметры, ""%1"")", ТокенАвторизации));
	КонецЕсли;
