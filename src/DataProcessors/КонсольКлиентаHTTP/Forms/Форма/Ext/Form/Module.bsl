...
&НаКлиенте
Процедура ОбработатьОпциюКомандыCurl(Опции, ЧастьКоманды, ДопустимыеОпции, Опция, СобиратьТокен, ЧастиТокена, Отказ, ОписаниеОшибки)
...
Функция ЧастиКомандыCurl(Знач СтрокаКоманды, Отказ, ОписаниеОшибки)
	...
	Для Каждого ЧастьКоманды Из ЧастиКоманды Цикл
		...
		Если СтрНачинаетсяС(ЧастьКоманды, "-") И НЕ СобиратьТокен Тогда
			ОбработатьОпциюКомандыCurl(фРезультат.Опции, ЧастьКоманды, ДопустимыеОпции, Опция, СобиратьТокен, ЧастиТокена, Отказ, ОписаниеОшибки);
			Если Отказ Тогда
				Возврат фРезультат;
			КонецЕсли;
