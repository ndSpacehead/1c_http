...
Функция ВыполнитьЗапросHTTP(Знач Метод, Знач Конфигурация, Знач Данные = Неопределено)
	...
	ОбработатьОтвет(Ответ, Конфигурация.ДополнительныеПараметры, Конфигурация.ДанныеURI);
