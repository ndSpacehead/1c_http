...
Функция ДКАПарсингаПеченья() Экспорт
	...
	ИмяПеченьки.Вставить(1, СостоянияДКА.ЗначениеПеченьки);
	ИмяПеченьки.Вставить(2, СостоянияДКА.ИмяАтрибута);
	ИмяПеченьки.Вставить(3, СостоянияДКА.ИмяПеченьки);

	ЗначениеПеченьки = Новый Соответствие;
	ЗначениеПеченьки.Вставить(2, СостоянияДКА.ИмяАтрибута);
	ЗначениеПеченьки.Вставить(3, СостоянияДКА.ИмяИлиЗначениеПеченьки);

	ИмяАтрибута = Новый Соответствие;
	ИмяАтрибута.Вставить(1, СостоянияДКА.ЗначениеАтрибута);
	ИмяАтрибута.Вставить(2, СостоянияДКА.ИмяАтрибута);
	ИмяАтрибута.Вставить(3, СостоянияДКА.ИмяПеченьки);

	ЗначениеАтрибута = Новый Соответствие;
	ЗначениеАтрибута.Вставить(2, СостоянияДКА.ИмяАтрибута);
	ЗначениеАтрибута.Вставить(3, СостоянияДКА.ИмяПеченькиИлиЗначениеАтрибута);

	ИмяИлиЗначениеПеченьки = Новый Соответствие;
	ИмяИлиЗначениеПеченьки.Вставить(1, СостоянияДКА.ЗначениеПеченьки);
	ИмяИлиЗначениеПеченьки.Вставить(2, СостоянияДКА.ИмяАтрибута);
	ИмяИлиЗначениеПеченьки.Вставить(3, СостоянияДКА.ИмяИлиЗначениеПеченьки);

	ИмяПеченькиИлиЗначениеАтрибута = Новый Соответствие;
	ИмяПеченькиИлиЗначениеАтрибута.Вставить(1, СостоянияДКА.ЗначениеПеченьки);
	ИмяПеченькиИлиЗначениеАтрибута.Вставить(2, СостоянияДКА.ИмяАтрибута);
	ИмяПеченькиИлиЗначениеАтрибута.Вставить(3, СостоянияДКА.ИмяПеченькиИлиЗначениеАтрибута);
