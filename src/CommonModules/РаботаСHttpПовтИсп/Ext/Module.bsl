...
Функция КодСостоянияУспешно() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Успешные.Успешно;
КонецФункции

Функция КодСостоянияСоздано() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Успешные.Создано;
КонецФункции

Функция КодСостоянияПеремещен() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Перенаправления.ПеремещенНаПостояннойОснове;
КонецФункции

Функция КодСостоянияНайден() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Перенаправления.Найден;
КонецФункции

Функция КодСостоянияВременноеПеренаправление() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Перенаправления.ВременноеПеренаправление;
КонецФункции

Функция КодСостоянияПлохойЗапрос() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.ПлохойЗапрос;
КонецФункции

Функция КодСостоянияНеАвторизовано() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.НеАвторизовано;
КонецФункции

Функция КодСостоянияЗапрещено() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.Запрещено;
КонецФункции

Функция КодСостоянияНеНайден() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.НеНайден;
КонецФункции

Функция КодСостоянияМетодНеРазрешен() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.МетодНеРазрешен;
КонецФункции

Функция КодСостоянияТаймаутНаКлиенте() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.Таймаут;
КонецФункции

Функция КодСостоянияУдалено() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.Удалено;
КонецФункции

Функция КодСостоянияПревышенЛимитТела() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.ПревышенЛимитТела;
КонецФункции

Функция КодСостоянияЧайник() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Клиентские.Чайник;
КонецФункции

Функция КодСостоянияВнутренняяОшибкаСервера() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Серверные.ВнутренняяОшибка;
КонецФункции

Функция КодСостоянияНеВыполнено() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Серверные.НеВыполнено;
КонецФункции

Функция КодСостоянияПлохойШлюз() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Серверные.ПлохойШлюз;
КонецФункции

Функция КодСостоянияСервисНедоступен() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Серверные.СервисНедоступен;
КонецФункции

Функция КодСостоянияТаймаутНаСервере() Экспорт
	Возврат РаботаСHttpПовтИсп.КодыСостояния().Серверные.Таймаут;
КонецФункции
#КонецОбласти

Функция КодыСостоянияПеренаправления() Экспорт
	фРезультат = Новый Соответствие;
	фРезультат.Вставить(РаботаСHttpПовтИсп.КодСостоянияПеремещен(), Истина);
	фРезультат.Вставить(РаботаСHttpПовтИсп.КодСостоянияНайден(), Истина);
	фРезультат.Вставить(РаботаСHttpПовтИсп.КодыСостояния().Перенаправления.ПросмотрДругихРесурсов, Истина);
	фРезультат.Вставить(РаботаСHttpПовтИсп.КодСостоянияВременноеПеренаправление(), Истина);
	фРезультат.Вставить(РаботаСHttpПовтИсп.КодыСостояния().Перенаправления.ПеренаправлениеНаПостояннойОснове, Истина);
