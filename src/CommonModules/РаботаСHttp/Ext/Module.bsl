...
// Добавление очередного значения параметра к уже имеющимся
//
// Параметры:
//     ПараметрыЗапроса - Соответствие - коллекция параметров запроса
//     Ключ - Строка - имя параметра
...
// Установка произвольного дополнительного параметра запроса
//
// Параметры:
//     ДополнительныеПараметры - Структура - коллекция дополнительных параметров запроса
...
// Установка MIME типа содержимого тела запроса
//
// Параметры:
//     ДополнительныеПараметры - Структура - коллекция дополнительных параметров запроса
...
// Добавление очередного текстового поля формы в теле POST запроса
//
// Параметры:
//     ПараметрыЗапроса - Соответствие - коллекция параметров запроса
...
// Добавление очередного поля с файлом в форме тела POST запроса
//
// Параметры:
//     ПараметрыЗапроса - Соответствие - коллекция параметров запроса
...
// Установка разделителя полей формы в теле POST запроса
//
// Параметры:
//     ДополнительныеПараметры - Структура - коллекция дополнительных параметров запроса
