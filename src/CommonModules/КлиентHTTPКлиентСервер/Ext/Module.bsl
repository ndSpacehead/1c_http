...
Функция ЗаголовкиЗапроса(Знач ДанныеURI, ДополнительныеПараметры)
	...
	Если ДополнительныеПараметры.Свойство("Разделитель") Тогда
...
Процедура ДобавитьРазделительПолейФормыВЗаголовкиЗапроса(Заголовки, Знач ДополнительныеПараметры)
	Если Заголовки.Получить("Content-Type") <> Неопределено Тогда
		Заголовки.Вставить("Content-Type", Заголовки.Получить("Content-Type") + "; boundary=" + ДополнительныеПараметры.Разделитель);
	КонецЕсли;
КонецПроцедуры
