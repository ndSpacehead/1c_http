...
Функция АутентификацияИмпортаPostman(Знач Запрос, Знач ЗначенияШаблонов)
	...
	Имена = СтрРазделить("Пароль,Пользователь,Токен,Пользователь,Пароль,РегионAWS,СервисAWS,Пользователь,Пароль", ",");
	ИменаИмпорт = СтрРазделить("password,username,token,accesskey,secretkey,region,service,authid,authkey", ",");
