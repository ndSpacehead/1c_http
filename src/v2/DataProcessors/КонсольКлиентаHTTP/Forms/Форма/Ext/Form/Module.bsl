...
Асинх Процедура ПрочитатьФайлИмпорта(ИмяФайлаИмпорта)
	...
	Если НЕ ФайлСуществует Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НачалоТекстаСообщения + "отсутствует файл " + ИмяФайлаИмпорта;
		Сообщение.Сообщить();
		Возврат;
	КонецЕсли;
	...
	Если ОбъектИмпорта.Отказ Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НачалоТекстаСообщения + ОбъектИмпорта.ОписаниеОшибки;
		Сообщение.Сообщить();
		Возврат;
	КонецЕсли;
	...
	Если Отказ Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НачалоТекстаСообщения + ОписаниеОшибки;
		Сообщение.Сообщить();
		Возврат;
	КонецЕсли;
...
Асинх Процедура ПрочитатьКомандуCurl(СтрокаКоманды)
	...
	Если НЕ СтрНачинаетсяС(НРег(СтрокаКоманды), "curl ") Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НачалоТекстаСообщения + "команда должна начинаться с имени утилиты curl";
		Сообщение.Сообщить();
		Возврат;
	КонецЕсли;
