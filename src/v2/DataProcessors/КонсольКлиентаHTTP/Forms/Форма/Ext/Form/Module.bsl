...
#Область Заполнение_запроса
	...
	ТипАутентификации = ОбъектИстории.ТипАутентификации;
	ПользовательАутентификации = ОбъектИстории.ПользовательАутентификации;
	ПарольАутентификации = ОбъектИстории.ПарольАутентификации;
	ТокенАутентификации = ОбъектИстории.ТокенАутентификации;
