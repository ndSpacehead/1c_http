...
// Возвращает результат валидации ответа сервера (Hawk аутентификация)
//
// Параметры:
...
//  Строка, Неопределено - значение charset заголовка Content-Type
//
Функция ОтветHawkКорректен(Знач Ответ, Знач ИмяЗаголовка, ОписаниеОшибки) Экспорт
	...
	Возврат КлиентHTTPВызовСервера.ОтветHawkКорректен(
