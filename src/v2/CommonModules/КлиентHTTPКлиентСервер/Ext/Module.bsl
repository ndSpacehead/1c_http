...
#Если НЕ МобильноеПриложениеСервер И НЕ МобильноеПриложениеКлиент И НЕ МобильныйКлиент Тогда
// Использовать клиентский сертификат OpenSSL, загружаемый из системного хранилища сертификатов операционной системы.
//  Недоступно для мобильной платформы.
//
// Параметры:
//  ДополнительныеПараметры	 - Структура - конфигурация выполнения запроса
// 
...
//  ОбщийМодуль.КлиентHTTPКлиентСервер - модуль вызова функции
//
Функция ИспользоватьСертификатКлиентаОС(ДополнительныеПараметры) Экспорт
	ДополнительныеПараметры.Вставить("СертификатК", Новый Структура("Тип", "ОС"));
...
#Если НЕ МобильноеПриложениеСервер И НЕ МобильноеПриложениеКлиент И НЕ МобильныйКлиент Тогда
// Использовать сертификаты удостоверяющих центров OpenSSL, загружаемые из системного хранилища сертификатов операционной системы.
//  Недоступно для мобильной платформы.
//
// Параметры:
//  ДополнительныеПараметры	 - Структура - конфигурация выполнения запроса
...
//  ОбщийМодуль.КлиентHTTPКлиентСервер - модуль вызова функции
//
Функция ИспользоватьСертификатыУдостоверяющихЦентровОС(ДополнительныеПараметры) Экспорт
	ДополнительныеПараметры.Вставить("СертификатыУЦ", Новый Структура("Тип", "ОС"));
...
Функция НовоеHTTPСоединение(Знач ДанныеURI, Знач ДополнительныеПараметры)
	...
	Если ДополнительныеПараметры.Свойство("СертификатК") Тогда
		ДПС = ДополнительныеПараметры.СертификатК;
		СертификатК = ?(
			ДПС.Тип = "Файл",
			Новый СертификатКлиентаФайл(ДПС.Файл.ПолноеИмя, ДПС.Пароль),
			Новый СертификатКлиентаОС()
		);
	КонецЕсли;
	Если ДополнительныеПараметры.Свойство("СертификатыУЦ") Тогда
		ДПСУЦ = ДополнительныеПараметры.СертификатыУЦ;
		СертификатыУЦ = ?(
			ДПСУЦ.Тип = "Файл",
			Новый СертификатыУдостоверяющихЦентровФайл(ДПСУЦ.Файл.ПолноеИмя, ДПСУЦ.Пароль),
