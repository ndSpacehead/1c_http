...
Функция ВыполнитьЗапросHTTP(Знач Метод, Знач Конфигурация, Знач Данные = Неопределено, Знач НомерПеренаправления = 0)
	...
	ПрименитьHawkАутентификацию(Метод, Данные, Конфигурация);
...
Процедура ПрименитьHawkАутентификацию(Знач Метод, Знач Данные, Конфигурация)
	...
	Конфигурация.Заголовки.Вставить("Authorization", КлиентHTTPВызовСервера.ЗаголовокHawk(Метод, Конфигурация, ДанныеАдресВХ));
КонецПроцедуры
