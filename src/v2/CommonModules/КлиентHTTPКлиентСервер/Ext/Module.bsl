...
Функция ПараметрыИдентификатора(Знач ИдентификаторРесурса, Знач ПозицияНачала)
...
Функция АдресРесурсаЗапроса(Знач Конфигурация)
	Возврат Конфигурация.ДанныеURI.АдресРесурса + ПараметрыЗапросаСтрокой(Конфигурация.Параметры);
КонецФункции
